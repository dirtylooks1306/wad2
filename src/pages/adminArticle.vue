...
const fetchArticles = async () => {
    ...
    console.log(articles.value[0]["Filter"])
};
...
const saveArticleChanges = async () => {
  ...
  try {
    ...
    const articleData = {
      ...
      Description: editedArticle.value.Description, // Entire content as a single field
    };
    ...
    <div>
        ...
        <div v-if="showEditModal" class="modal-overlay" @click.self="closeEditModal">
            <div class="modal-content">
                ...
                <label>Description</label>
                <textarea v-model="editedArticle.Description" placeholder="Enter the article content with paragraphs and blank lines as needed" required></textarea>
