        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="publishArticle">
            ...
            <div class="form-group">
                ...
                <select id="category" v-model="newArticle.Category" required class="form-select full-width">
      ...
      <div v-if="showEditModal" class="modal-overlay" @click.self="closeEditModal">
        <div class="modal-content">
            ...
            <form @submit.prevent="saveArticleChanges">
                ...
                <div class="form-group">
                  <label for="category" class="form-label">Category</label>
                  <select id="category" v-model="editedArticle.Category" required class="form-select full-width">
                      <option disabled value="">Select Category</option>
                      <option>Activities</option>
                      <option>Education</option>
                      <option>Nutrition</option>
