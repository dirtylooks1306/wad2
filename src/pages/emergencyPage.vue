	...
	<div class="map-block p-3 position-relative">
		...
		<div id="helpPrompt" class="position-absolute popup">
			...
			<span class="popuptext p-2" id="helpPopUp">
				1. Click on the "Find Nearest A&E" button to locate your nearest
				hospital<br />
				2. Click on the hospital's location marker and click "View on
				Google Maps" to start calibrating your navigation route!
			</span>
		</div>
		<div id="map">
		...
		<div class="centered-container">
			<form id="searchLocation">
				<button
					type="button"
					class="btn btn-success m-2 p-1"
					@click="findNearest()"
				>
					<span>Find nearest A&E</span>
				</button>
				<!-- To add function for button -->
			</form>
			<span id="nearest"
				>Nearest hospital: <strong>{{ nearest }}</strong></span
			>
		</div>
	</div>
    ...
    -->
		<table class="contacts-list w-100 mx-auto table-bordered">
			...
			<tbody>
				...
				<tr>
					<td>PARENT COUNSELLINGING HOTLINE</td>
					<td>1800 222 0000</td>
				</tr>
			</tbody>
		</table>
		<p class="enquiries">
			...
			<a class="contact-link" href="diary">here</a>.
		</p>
		<!-- href link is temporary, to change later if contact page is present -->
	</div>
</template>
...
export default {
			...
			locations: [
				{
					...
					lat: 1.2874962987730814,
					lng: 103.80073267207732,
				},
				{
					name: "Changi General Hospital",
					lat: 1.34404999352938,
					lng: 103.94960279625784,
				},
				{
					name: "Gleneagles Hospital",
					lat: 1.30764521242119,
					lng: 103.8198628858667,
				},
				{
					name: "Khoo Teck Puat Hospital",
					lat: 1.4243705790643706,
					lng: 103.8385962294709,
				},
				{
					name: "KK Women's and Children's Hospital",
					lat: 1.311177296639997,
					lng: 103.84681932461908,
				},
				{
					name: "Mount Alvernia Hospital",
					lat: 1.3420612484696135,
					lng: 103.83770458957798,
				},
				{
					name: "Mount Elizabeth Hospital",
					lat: 1.3055822026727748,
					lng: 103.83582102084704,
				},
				{
					name: "Mount Elizabeth Novena Hospital",
					lat: 1.322267321333642,
					lng: 103.84404006861622,
				},
				{
					name: "Sengkang General Hospital",
					lat: 1.3956941909342555,
					lng: 103.89332626317386,
				},
				{
					name: "National University Hospital",
					lat: 1.2945680095759684,
					lng: 103.78301453136561,
				},
				{
					name: "Ng Teng Fong General Hospital",
					lat: 1.3343167862509524,
					lng: 103.7452355572338,
				},
				{
					name: "Parkway East Hospital",
					lat: 1.3152592115077777,
					lng: 103.9090328445181,
				},
				{
					name: "Raffles Hospital",
					lat: 1.3011719940290543,
					lng: 103.85708979562519,
				},
				{
					name: "SGH A&E",
					lat: 1.27887889121749,
					lng: 103.83490623940729,
				},
				{
					name: "Tan Tock Seng Hospital",
					lat: 1.321445820283406,
					lng: 103.84583988689484,
				},
				{
					name: "Woodlands Health Campus",
					lat: 1.430755656187611,
					lng: 103.79459742535192,
				},
			],
			nearest: null,
		};
	...
	methods: {
		computeDist(lat1, lat2, lon1, lon2) {
			...
			const a =
				Math.sin(latRadDiff / 2) * Math.sin(latRadDiff / 2) +
				Math.cos(latRad1) *
					Math.cos(latRad2) *
					Math.sin(lonRadDiff / 2) *
					Math.sin(lonRadDiff / 2);
