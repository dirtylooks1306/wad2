...
import { getFirestore, collection, addDoc, doc, setDoc, getDoc, updateDoc, deleteDoc, getDocs, query, where,onSnapshot, orderBy, Timestamp, limit } from 'https://www.gstatic.com/firebasejs/10.14.0/firebase-firestore.js';
